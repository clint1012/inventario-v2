...
<form action="<?= base_url('bienes') ?>" class="row g-3" method="post" autocomplete="off">
    ...
    <div class="col-md-6">
        ...
        <select class="form-select form-control" id="procesador" name="procesador" required
            ...
            <option value="core i5-7ma" <?= set_value('procesador') === 'core i5-7ma' ? 'selected' : '' ?>>Core i5-7ma Gen
            </option>
            <option value="core i5-9na" <?= set_value('procesador') === 'core i5-9na' ? 'selected' : '' ?>>Core i5-9na Gen
            </option>
            <option value="core i7-7ma" <?= set_value('procesador') === 'core i7-7ma' ? 'selected' : '' ?>>Core i7-7ma Gen
            </option>
            <option value="core i7-9na" <?= set_value('procesador') === 'core i7-9na' ? 'selected' : '' ?>>Core i7-9na Gen
            </option>
            <option value="core i7-10ma" <?= set_value('procesador') === 'core i7-10ma' ? 'selected' : '' ?>>Core i7-10ma
                Gen</option>
            <option value="core i7-11va" <?= set_value('procesador') === 'core i7-11va' ? 'selected' : '' ?>>Core i7-11va
                Gen</option>
            <option value="core i7-14va" <?= set_value('procesador') === 'core i7-14va' ? 'selected' : '' ?>>Core i7-14va
                Gen</option>
            <option value="core i7-ultra" <?= set_value('procesador') === 'core i7-utra' ? 'selected' : '' ?>>Core i7-Ultra
            </option>
    ...
    <div class="col-md-6">
        ...
        <select class="form-select form-control" id="sistema_operativo" name="sistema_operativo" required
            ...
            <option value="">Seleccionar</option>
            <option value="Windows 10" <?= set_value('sistema_operativo') === 'Windows 10' ? 'selected' : '' ?>>Windows 10
            </option>
            <option value="Windows 11" <?= set_value('sistema_operativo') === 'Windows 11' ? 'selected' : '' ?>>Windows 11
            </option>
            ...
            <option value="NO APLICA" <?= set_value('sistema_operativo') === 'NO APLICA' ? 'selected' : '' ?>>No Aplica
            </option>
    ...
    <div class="col-md-6">
        ...
        <select class="form-select form-control" id="ver_office" name="ver_office" required>
            <option value="">Seleccionar</option>
            <option value="Microsoft 365" <?= set_value('ver_office') === 'Microsoft 365' ? 'selected' : '' ?>>Microsoft
                365</option>
